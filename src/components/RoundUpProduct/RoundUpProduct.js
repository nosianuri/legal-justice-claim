    ...
    return (
        <div className='grid lg:grid-cols-2 grid-cols-1 lg:gap-16'>
            <div>
                ...
                <p>Numerous studies have been conducted and most published medical studies have indicated that the use of talc-based powders is associated with a 33-percent increased risk of developing Ovarian Cancer. <span className='font-bold underline text-[#BD902D]'>Read More »</span></p>
                <div className='my-5'>
            ...
            <div>
                ...
                <p>In September 2019, Valisure, an online pharmacy based in Connecticut, informed the U.S. Food and Drug Administration that it had found the cancer-causing chemical NDMA in some batches of Zantac® (ranitidine)… <span className='font-bold underline text-[#BD902D]'>Read More »</span></p>
                <div className='my-5'>
