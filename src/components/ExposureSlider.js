    ...
    const images = [
        {
            ...
            heading: 'RoundUp Exposure linked to Cancer',
        ...
        },
        {
            ...
            heading: 'Exposure to the contaminated water',
        ...
        },
        {
            ...
            heading: 'Exposure to trauma is a relative',
        ...
        },
        {
            ...
            heading: 'Plaintiffs have sued Johnson & Johnson',
        ...
        },
        {
            ...
            heading: 'Exposure to Tylenol generic acetaminophen',
        ...
        },
        {
            ...
            heading: 'Exposure to chemicals in hairRelaxer',
        ...
        },
        {
            ...
            heading: 'Exposure to the PFAS chemicals in AFFF',
        ...
        <div className="max-w-7xl mx-auto">
            <Slider {...settings}>
                {images.map((image) => (
                    <div key={image.id}>
                        <div>
                            <h1 className='lg:text-6xl text-2xl mt-2 mb-5 overflow-y-hidden'>{image.heading}</h1>
