    ...
    return (
        <div class="py-5  bg-no-repeat !bg-cover" style={{
            ...
            <div className='elmiron-box lg:w-1/2 '>
                <h1 className='lg:text-4xl text-2xl pt-3 mb-3'>Have you used Elmiron?</h1>
                <p className='lg:text-2xl text-md mb-3'>Have You Experienced Vision & Eye Problems After Long Term Elmiron Use?</p>
