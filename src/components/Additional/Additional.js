    ...
    return (
        <div>
            ...
            <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 mt-5'>
                <div>
                    <img src="https://i.ibb.co/4JBx01G/grid-bg-roundup.png" alt="" />
                    <div>
                        <h5 className='text-md font-semibold text-blue-800'>RoundUp RoundUp®</h5>
                ...
                <div>
                    <img className='w-1/2' src="https://i.ibb.co/vsYjkpH/legal-funding.jpg" alt="" />
                    <div>
                        <h5 className='text-md font-semibold text-blue-800'>Get Settlement</h5>
                        <p className='text-xs'>Living expenses and bills can add up fast. Receiving your deserved money can take a long time..
                        </p>
                        <button className='underline text-xs text-[#BD902D] font-semibold'>READ MORE »</button>
                    </div>
                </div>
                <div>
                    <img src="https://i.ibb.co/Vxs0wyw/grid-bg-talcumpowder.png" alt="" />
                    <div>
                        <h5 className='text-md font-semibold text-blue-800'>Talcum Powder</h5>
                ...
                <div>
                    <img src="https://i.ibb.co/Q8Gt1rb/grid-bg-personal-injury.png" alt="" />
                    <div>
                        <h5 className='text-md font-semibold text-blue-800'>Personal Injury</h5>
                ...
                <div>
                    <img src="https://i.ibb.co/5xTWyTr/grid-bg-org-abuse.jpg" alt="" />
                    <div>
                        <h5 className='text-md font-semibold text-blue-800'>Org Abuse</h5>
                ...
                <div>
                    <img src="https://i.ibb.co/Fws28s7/grid-bg-paragard.jpg" alt="" />
                    <div>
                        <h5 className='text-md font-semibold text-blue-800'>Paragard</h5>
                ...
                <div>
                    <img src="https://i.ibb.co/myhGky5/grid-bg-truvada.jpg" alt="" />
                    <div>
                        <h5 className='text-md font-semibold text-blue-800'>Truvada</h5>
                ...
                <div>
                    <img src="https://i.ibb.co/3RF86CT/grid-bg-clergy-abuse.jpg" alt="" />
                    <div>
                        <h5 className='text-md font-semibold text-blue-800'>Clergy Abuse</h5>
