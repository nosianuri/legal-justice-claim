      ...
      <div className='grid lg:grid-cols-2 grid-cols-1 gap-10 my-10'>
        ...
        <div>
          ...
          <div className='flex space-x-5 mt-5'>
            ...
            <div>
              <h3 className='text-[#13100E]  text-lg'><a className='hover:text-[#BD902D]' href="/zantac">Round Up</a></h3>
          ...
          <div className='flex space-x-5 mt-5'>
            ...
            <div>
              <h3 className='text-[#13100E]  text-lg'><a className='hover:text-[#BD902D]' href="/">Camp Lejeune</a></h3>
              <h5 className='text-[#300303] text-md leading-none mb-1'>FDA calls for Zantac to be pulled from market immediately</h5>
          ...
          <div className='flex space-x-5 mt-5'>
            ...
            <div>
              <h3 className='text-[#13100E] text-lg'><a className='hover:text-[#BD902D]' href="/">MVA
              </a></h3>
              <h5 className='text-[#300303] text-md leading-none mb-1'>FDA calls for Zantac to be pulled from market immediately</h5>
              <p className='text-xs'>The FDA has warned that Zantac® may be contaminated with cancer-causing agent...<span className='text-[#BD902D] font-bold'><a className='hover:text-[#13100E]' href="/">MORE »</a></span></p>
            </div>
        ...
        <div className=''>
          ...
          <div className='flex space-x-5 mt-5'>
            ...
            <div>
              <h3 className='text-[#13100E] text-lg'><a className='hover:text-[#BD902D]' href="/">Talcom Powder</a></h3>
              <h5 className='text-[#300303] text-md leading-none mb-1'>FDA calls for Zantac to be pulled from market immediately</h5>
              <p className='text-xs'>The FDA has warned that Zantac® may be contaminated with cancer-causing agent...<span className='text-[#BD902D] font-bold'><a className='hover:text-[#13100E]' href="/">MORE »</a></span></p>
            </div>
          </div>
          <div className='flex space-x-5 mt-5'>
            ...
            <div>
              <h3 className='text-[#13100E]  text-lg'><a className='hover:text-[#BD902D]' href="/">NEC
              </a></h3>
              <h5 className='text-[#300303] text-md leading-none mb-1'>FDA calls for Zantac to be pulled from market immediately</h5>
              <p className='text-xs'>The FDA has warned that Zantac® may be contaminated with cancer-causing agent...<span className='text-[#BD902D] font-bold'><a className='hover:text-[#13100E]' href="/">MORE »</a></span></p>
            </div>
