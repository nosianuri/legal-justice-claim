...
import d1 from '../../../assets/Medical Malpractice (1).jpg';
import d2 from '../../../assets/Roundup (1).jpg';
import d3 from '../../../assets/Zantac (1).jpg';
  ...
  return (
    <div>
        <div className='lg:mx-36 mt-16 px-5 lg:px-0'>
            ...
            <p className='my-3 hover:underline'><a className=' text-blue-800' href="https://www.forbes.com/advisor/legal/product-liability/3m-earplug-lawsuit/">3M Earplug Lawsuit Update January 2023</a></p>
            <p className='mb-10 hover:underline'><a className=' text-blue-800' href="https://www.lawsuit-information-center.com/13-million-3m-earplug-verdict.html">3M Earplug Lawsuit News</a></p>
            <div className='mb-10'>
