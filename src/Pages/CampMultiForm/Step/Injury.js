                ...
                <div className='text-center'>
                    ...
                    <div className='my-5'>
                        <div className="inline-block relative w-40">
                            <select className="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" id='pinjur' name="injury_type_list" required>
