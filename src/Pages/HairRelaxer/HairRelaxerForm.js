...
const HairRelaxerForm = () => {
  return (
    <div className='my-10 max-w-7xl mx-auto form_box rounded-2xl' id='get-claim'>
    <div className=' text-center py-5  sm:mx-0 mx-2'>
        <h2 className='font-bold text-3xl text-[#800020] uppercase'>SEE IF YOU ARE ELIGIBLE FOR Hair Relaxer CLAIM</h2>
...
export default HairRelaxerForm