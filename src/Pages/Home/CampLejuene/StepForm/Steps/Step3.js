...
const Step3 = ({ page, setPage, setAllData, AllData }) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className='text-center'>
          ...
          <div className='my-5'>
            <div className="inline-block relative w-full">
              <select className="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow focus:outline-none focus:shadow-outline"
      ...
      <div className="footer mt-5">
        ...
        <input className="sm:text-xl text-lg cursor-pointer rounded-lg bg-[#228B22] py-2 px-4 font-semibold uppercase text-white transition duration-200 ease-in-out hover:bg-[#1b6f1b] hover:text-white" type="submit" value="Continue" />
      </div>
    </form>
  </div>
  )
