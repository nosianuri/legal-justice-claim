...
const Step5 = ({ page, setPage, onSubmit }) => {
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className='flex gap-1'>
        <div className=" mx-2 flex-1">
          ...
          <div className="bg-white mb-2 p-1 flex border border-gray-400 hover:border-blue-400 rounded">
            <input name="address" type="text" className="p-1 px-2 appearance-none outline-none w-full text-gray-800"
              {...register("address", {
                required: {
                  value: true,
      ...
      <div className="footer mt-5">
        ...
        <input className="sm:text-xl text-lg cursor-pointer rounded-lg bg-[#228B22] py-2 px-4 font-semibold uppercase text-white transition duration-200 ease-in-out hover:bg-[#1b6e1b] hover:text-white" type="submit" value="Submit" />
      </div>
    </form>
  </div>
  )
