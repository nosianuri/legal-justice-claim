...
const RounUpForm = () => {
  return (
    ...
    <div className=' text-center py-5  sm:mx-0 mx-2'>
        <h2 className='font-bold text-3xl text-[#800020] uppercase'>SEE IF YOU ARE ELIGIBLE FOR RoundUp CLAIM</h2>
