        ...
        <div className='lg:px-32 px-8 bg-black bg-opacity-25'>
            <div className='grid lg:grid-cols-2 grid-cols-1 gap-10'>
                <div className='lg:py-16 py-5 lg:mx-16 order-2'>
                    <h1 className='lg:text-5xl text-4xl text-center font-bold'>Roundup® Lawsuits are now being filed!</h1>
                    <h3 className='text-[#300303] lg:text-[35px] text-2xl text-center my-5 leading-tight font-semibold'>Roundup® Maker Agrees to Pay $10 Billion to Settle Cancer Suits as of June 24, 2020*</h3>
                ...
                <div className='lg:order-2'>
                    <div className='lg:hidden blocked text-center my-5'>
                        <h2 className='lg:text-5xl text-4xl text-center font-bold'>Roundup® Lawsuits are now being filed!</h2>
                        <h5 className='text-[#300303] lg:text-[35px] text-2xl text-center my-5 leading-tight font-semibold'>Roundup® Maker Agrees to Pay $10 Billion to Settle Cancer Suits as of June 24, 2020*</h5>
                    </div>
                    <RuForm />
                </div>
            </div>
