...
import d7 from '../../../assets/NEC (1).jpg';
import d8 from '../../../assets/Truck Accident.jpg';
import d9 from '../../../assets/Sex Abuse (1).jpg';
import d10 from '../../../assets/Car Accident.jpg';
    ...
    return (
        <div>
            <div className='lg:mx-36 mt-16 px-5 lg:px-0'>
                ...
                <p className='my-3 hover:underline'><a className=' text-blue-800' href="https://thelawdictionary.org/article/average-personal-injury-settlements/">https://thelawdictionary.org/article/average-personal-injury-settlements/</a></p>
                <p className='mb-10 hover:underline'><a className=' text-blue-800' href="https://www.cdc.gov/nchs/fastats/accidental-injury.htm">https://www.cdc.gov/nchs/fastats/accidental-injury.htm</a></p>
                <div className='mb-10'>
