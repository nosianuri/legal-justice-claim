          ...
          <div className='grid lg:grid-cols-2 grid-cols-1 gap-5'>
              ...
              <div className='lg:order-2'>
                  <div className='lg:hidden blocked text-center my-5'>
                      <h2 className='lg:text-5xl text-4xl text-center font-semibold'>Personal Injury Lawsuits are now being filed!</h2>
                      <h5 className='text-[#300303] lg:text-[35px] text-2xl text-center my-5 leading-tight font-semibold'>Recent study Personal Injury claims earn an average $24,000 in compensation*</h5>
                  </div>
                  <MmForm />
              </div>
          </div>
