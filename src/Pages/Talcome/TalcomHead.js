    ...
    return (
        <div>
            <div className='bg-[#800020]'>
                <h2 className='text-[28px] lg:text-[32px] md:text-[40px] text-white sm:mt-0 text-center py-5 font-primary italic mt-0 font-bold'>Talcum Powder Lawsuits are now being filed!
                </h2>
            </div>
                    ...
                    <div className='container mx-auto lg:min-h-[320px]  min-h-[200px] flex justify-center items-center'>
                        <div className='text-center flex flex-col'>
                            <div
                                ...
                                <h4 className='text-[20px] lg:text-[32px] md:text-[25px] text-white mt-2'>Johnson & Johnson® stopped selling Talc baby powder in U.S. as of May 19th, 2020<em className='text-red-700'>*</em>
                                </h4>
