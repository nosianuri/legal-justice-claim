        ...
        <div className='grid lg:grid-cols-2 grid-cols-1 gap-10'>
                ...
                <div>
                    <div className='lg:hidden blocked text-center mb-5'>
                        <h2 className='text-3xl'>Zantac® lawsuits are now being filed!</h2>
                        <h5 className='text-xl'>FDA calls for heartburn drug Zantac to be pulled from market immediately, April 1, 2020*</h5>
                    </div>
                    <ZantacForm />
                </div>
            </div>
