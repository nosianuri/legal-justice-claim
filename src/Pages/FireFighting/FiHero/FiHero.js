...
const FiHero = () => {
  return (
    <div style={{
        background: `url(https://i.ibb.co/gzKCBdk/firefighting.jpg)`
    }} class="bg-no-repeat !bg-cover">
        <div className='lg:px-32 px-8'>
            <div className='grid lg:grid-cols-2 grid-cols-1 gap-10'>
                <div className='lg:py-16 py-5 lg:mx-16'>
                    <h1 className='lg:text-5xl text-4xl text-center'>Winning Claims for Military Veterans!</h1>
                    <h3 className='text-[#300303] lg:text-[35px] text-2xl text-center my-5 leading-tight'>3M Company Agrees to Pay $9.1 Million as of July 26, 2018*</h3>
                ...
                <div>
                    <div className='lg:hidden blocked text-center mb-5'>
                        <h2 className='text-3xl'>Winning Claims for Military Veterans!</h2>
                        <h5 className='text-xl'>3M Company Agrees to Pay $9.1 Million as of July 26, 2018*</h5>
                    </div>
                    <FiForm />
                </div>
            </div>
