        ...
        <div className='lg:px-32 px-8'>
            <div className='grid lg:grid-cols-2 grid-cols-1 gap-10'>
                <div className='lg:py-16 py-5 lg:mx-16'>
                    <h1 className='lg:text-5xl text-4xl text-center'>Southern Baptist Church Lawsuits are now being filed!</h1>
                    <h3 className='text-[#300303] lg:text-[35px] text-2xl text-center my-5 leading-tight'>SBC Sexual Abuse Cover-Up & Cases. New May 2022 report reveals 700 victims of Southern Baptist sexual abuse ***</h3>
                ...
                <div>
                    <div className='lg:hidden blocked text-center mb-5'>
                        <h2 className='text-3xl'>Southern Baptist Church Lawsuits are now being filed!</h2>
                        <h5 className='text-xl'>SBC Sexual Abuse Cover-Up & Cases. New May 2022 report reveals 700 victims of Southern Baptist sexual abuse ***</h5>
                    </div>
                    <SaForm />
                </div>
            </div>
