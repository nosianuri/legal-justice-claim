        ...
        <div className='mb-16 bg-[#f0f0f0] border-8 border-[#f0f0f0] lg:mt-[-20px] rounded-t-xl shadow-xl'>
            <div className='p-5'>
                ...
                <div className='flex gap-10 py-1 lg:px-3 mt-3 '>
                    <p className='lg:text-lg text-xs'>Were you a firefighter or U.S. Military Servicemember exposed to firefighting foam (AFFF)?</p>
                ...
                <div className='flex gap-10 py-1 lg:px-3'>
                    <p className='lg:text-lg text-xs'>Have you or a loved one developed any of the following conditions after being exposed to Firefighting Foam (AFFF)?</p>
                    <div className=''>
                ...
                <div className='lg:w-full w-full h-[1px] bg-gray-300 '></div>
                <div className='flex gap-10 py-1 lg:px-3'>
                    <p className='lg:text-lg text-xs'>Do you currently have a lawyer
