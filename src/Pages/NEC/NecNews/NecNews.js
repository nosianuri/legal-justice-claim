...
const NecNews = () => {
  return (
    ...
    <div className='lg:mx-36 mt-16 px-5 lg:px-0'>
        ...
        <p className='my-3 hover:underline'><a className=' text-blue-800' href="https://pubmed.ncbi.nlm.nih.gov/1979363/">Breast milk and neonatal necrotising enterocolitis</a></p>
